...
![](`r file.path("figures", "ch2_technology", "sentiments_marine_mean_over_time_neg_pos.png")`)

To download high resolution, [click here](`r file.path("figures", "ch2_technology", "sentiments_marine_mean_over_time_neg_pos.pdf")`){target="_blank"}

![](`r file.path("figures", "ch2_technology", "sentiments_marine_mean_over_time_neg_poss_ridge.png")`)

To download high resolution, [click here](`r file.path("figures", "ch2_technology", "sentiments_marine_mean_over_time_neg_pos_ridge.pdf")`){target="_blank"}
