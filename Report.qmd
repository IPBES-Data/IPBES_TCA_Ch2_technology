...
```{r}
#| label: get get_technology_count
#|
...
### Number of hits
- **vision:**: `r formatC(vision_count, format="f", big.mark=",", digits=0)` hits
- **technology:** `r formatC(technology_count, format="f", big.mark=",", digits=0)` hits
- **vision AND technology:** `r formatC(vision_technology_count, format="f", big.mark=",", digits=0)` hits
